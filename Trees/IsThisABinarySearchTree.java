...
public class BST {
    ...
    public static boolean isBST(TreeNode node) {
        return isBSTRec(node, null, null);
    }
    
    public static boolean isBSTRec(TreeNode node, Integer upperLimit, Integer lowerLimit) {
        ...
        if(node.left != null) {
            isLeftBST = isBSTRec(node.left, node.value, lowerLimit);
        }
        if(isLeftBST && node.right != null) {
            isRightBST = isBSTRec(node.right, upperLimit, node.value);
        }
